...
```bash
adb push dist/LuneDisplayBridge-v2.0.0.zip /sdcard/Download/
```
...
```bash
# Magisk
adb shell su -c "magisk --install-module /sdcard/Download/LuneDisplayBridge-v2.0.0.zip"

# KernelSU
adb shell su -c "ksud module install /sdcard/Download/LuneDisplayBridge-v2.0.0.zip"
```
