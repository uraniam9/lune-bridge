...
```bash
adb push dist/LuneBridge-v2.0.1.zip /sdcard/Download/
```
...
```bash
# Magisk
adb shell su -c "magisk --install-module /sdcard/Download/LuneBridge-v2.0.1.zip"

# KernelSU
adb shell su -c "ksud module install /sdcard/Download/LuneBridge-v2.0.1.zip"
```
